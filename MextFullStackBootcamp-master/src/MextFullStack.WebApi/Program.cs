...
builder.Services.AddSingleton<IRoothPathService,RootPathManager>(container=>new RootPathManager(builder.Environment.WebRootPath,container.GetRequiredService<RequestCounterManager>()));
//wwrootun yolunu bir kere oluþturup o yolu verecek 
//Scoped
//Translent
